    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: true,
                logo: {
                    darkLogo: '../../assets/img/rki_icon.png',
                    lightLogo: '../../assets/img/rki_icon.png'
                }
            }
        },
        reset: false
    ...
    if (corkThemeObject.settings.layout.darkMode) {
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                ...
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '../../assets/img/rki_icon.png')
                }
            }
        }
    } else {
        ...
        if (!getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '../../src/assets/img/rki_icon.png')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '../../assets/img/rki_icon.png')
